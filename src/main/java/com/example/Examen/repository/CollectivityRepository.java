...
import com.example.Examen.mapper.CollectivityMapper;
...
public class CollectivityRepository {
    ...
    public List<Collectivity> saveAll(List<Collectivity> collectivities) {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement(
                ...
                """
                insert into "collectivity" (id, name, number, location, specialization, president_id, vice_president_id, treasurer_id, secretary_id) 
                values (?, ?, ?, ?, ?, ?, ?, ?, ?) 
    ...
    public Optional<Collectivity> findById(String id) {
        try (PreparedStatement preparedStatement = connection.prepareStatement(
                "select id, name, number, location, specialization, president_id, vice_president_id, treasurer_id, secretary_id from \"collectivity\" where id = ?")) {
    ...
    public List<Collectivity> findAllByMemberId(String memberId) {
        ...
        try (PreparedStatement preparedStatement = connection.prepareStatement("""
                // Remplace par :
                "select id, name, number, location, specialization, president_id, 
                vice_president_id, treasurer_id, secretary_id from \\"collectivity\\" ..."
                """)) {
