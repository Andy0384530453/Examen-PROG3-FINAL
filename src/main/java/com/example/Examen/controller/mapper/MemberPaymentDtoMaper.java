...
public class MemberPaymentDtoMaper {
    ...
    public com.example.Examen.controller.dto.MemberPayment mapToDto(MemberPayment memberPayment) {
        return com.example.Examen.controller.dto.MemberPayment.builder()
                .id(memberPayment.getId())
                .paymentMode(memberPayment.getPaymentMode() == null ? null : com.example.Examen.controller.dto.PaymentMode.valueOf(memberPayment.getPaymentMode().name()))
